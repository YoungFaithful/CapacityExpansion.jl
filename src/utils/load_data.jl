...
function load_timeseries_data_provided(region::String="GER_1";
    ...
    region in readdir(normpath(joinpath(dirname(@__FILE__),"..","..","data"))) || throw(@error "The region $region is not found. The provided regions are: `"GER_1"`: Germany 1 node, `"GER_18"`: Germany 18 nodes, `"CA_1"`: California 1 node, `"CA_14"`: California 14 nodes, `"TX_1"`: Texas 1 node ")
