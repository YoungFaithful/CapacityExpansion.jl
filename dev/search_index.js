...
{
    "location": "load_data/#ClustData-Time-Series-Data-1",
    "page": "Load Data",
...
{
    "location": "load_data/#Provided-Data-1",
    "page": "Load Data",
    "title": "Provided Data",
    "category": "section",
...

{
    ...
    "category": "function",
    "text": "load_timeseriesdata(data_path::String; T-#Segments,\n\nyears::Array{Int64,1}=# years to be selected for the time series, att::Array{String,1}=# attributes to be loaded)\n\nLoading all *.csv files in the folder or the file data_path\n\nThe *.csv files shall have the following structure and must have the same length: |Timestamp |[column names...]| |[iterator]|[values]         | The first column should be called Timestamp if it contains a time iterator The other columns can specify the single timeseries like specific geolocation. Each column in [file name].csv file will be added to the ClustData.data called \"[file name]-[column name]\" Loads all attributes if the att-Array is empty or only the ones specified in it\n\n\n\n\n\n"
},

{
    "location": "load_data/#Your-own-Data-1",
    "page": "Load Data",
    "title": "Your own Data",
    "category": "section",
    "text": "For details refer to ClustForOpt !!! The keys of {your-time-series}.data have to match \"{time_series (as declared in techs.csv)}-{node}\"load_timeseries_data"
},

{
    "location": "load_data/#Aggregation-1",
    "page": "Load Data",
    "title": "Aggregation",
    "category": "section",
    "text": "Time series aggregation can be applied to reduce the temporal dimension while (if done problem specific correctly) keeping output precise. Aggregation methods are explained in ClustForOpt High encouragement to run a second stage validation step if you use aggregation on your model. Example for second stage operational validation step"
},

{
    "location": "load_data/#Examples-1",
    "page": "Load Data",
    "title": "Examples",
    "category": "section",
    "text": ""
...
{
    "location": "load_data/#Loading-time-series-data-1",
    "page": "Load Data",
...
{
    "location": "load_data/#Aggregating-time-series-data-1",
    "page": "Load Data",
...
{
    "location": "load_data/#OptDataCEP-1",
    "page": "Load Data",
    "title": "OptDataCEP",
    "category": "section",
    "text": ""
...
{
    "location": "load_data/#CEP.load_cep_data_provided",
    "page": "Load Data",
...
{
    "location": "load_data/#Provided-Data-2",
    "page": "Load Data",
    "title": "Provided Data",
    "category": "section",
...
{
    "location": "opt_cep/#CEP.OptDataCEP",
    "page": "Optimization",
...
{
    "location": "opt_cep/#CEP.OptVariable",
    "page": "Optimization",
...
{
    "location": "opt_cep/#CEP.Scenario",
    "page": "Optimization",
    "title": "CEP.Scenario",
    "category": "type",
    "text": " Scenario{descriptor::String,clust_res::ClustResult,opt_res::OptResult}\n\n-descriptor::String -clust_res::ClustResult -opt_res::OptResult\n\n\n\n\n\n"
},
...
{
    "location": "opt_cep/#CEP.get_cep_variable_set",
    "page": "Optimization",
...
{
    "location": "opt_cep/#CEP.get_cep_slack_variables",
    "page": "Optimization",
...
{
    "location": "opt_cep/#CEP.get_cep_design_variables",
    "page": "Optimization",
